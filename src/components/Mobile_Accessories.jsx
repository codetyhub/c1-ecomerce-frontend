  ...
  return (
    <div className="w-fit md:w-[90%] h-500 mx-auto mt-5 bg-[#F7FAFC] border  border-gray-300    rounded-lg p-3 ">
      <div className="w-full mt-4 md:flex flex-col justify-center hidden">
        <div className="bg-white px-4 text-black border border-gray-300 py-1 my-3 rounded-md w-full flex flex-row items-center justify-between">
          <span>
          ...
          <div className="flex flex-row ">
            <div className="flex flex-row items-center">
              <button className="mx-1 bg-white text-black font-bold text-xs h-5 w-5 py-0.5 px-2 mt-2 mb-2 rounded-md border border-gray-500"></button>
              <p className="ml-1">verified only</p>
            </div>

            <button className="mx-1 bg-white text-black semi-bold py-2 px-4 rounded-lg border border-gray-300">
              featured
            </button>
