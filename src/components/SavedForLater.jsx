...
const SavedForLater = () => {
  return (
    ...
    <h2 class="font-bold py-4 text-xl">Saved for later</h2>
    <div class="flex gap-5 justify-center">   
      <div class="bg-none rounded-lg  p-4 max-w-sm">
        <img src={ohj} alt="" className="w-full h-48 object-cover rounded-lg mb-4"/>
        <h2 class="text-xl font-bold mb-2">$99.50</h2>
        <p class="text-gray-700 mb-4">GoPro HERO6 4K Action Camera - Black</p>
