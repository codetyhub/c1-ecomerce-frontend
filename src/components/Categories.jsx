...
const Categories = () => {
    return (
        <div className="rounded-lg hidden lg:block p-5 border border-black-500 bg-white">
            ...
            <hr className="w-full border-t border-black my-1 my-1border-opacity-30"></hr>
            ...
            <div className="flex flex-col items-left gap-2">
                <div class="flex items-center">
                    <input type="checkbox"
                           className="form-checkbox h-5 w-5 text-blue-500 checked:bg-blue-500 checked:border-transparent"
                           checked/>
                ...
                <div className="flex items-left"><input type="checkbox"
                                                        className="form-checkbox h-5 w-5 text-blue-500 checked:bg-blue-500 checked:border-transparent"
                                                        checked/>
